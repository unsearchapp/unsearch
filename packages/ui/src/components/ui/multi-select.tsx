...
import { CheckIcon, Cross1Icon, CrossCircledIcon, ChevronDownIcon } from "@radix-ui/react-icons";
								...
								<div className="flex flex-wrap items-center">
									{selectedValues.slice(0, maxCount).map((value) => {
										...
										return (
											...
											>
												{IconComponent && <img src={IconComponent} className="mr-2 h-4 w-4" />}
												{option?.label}
												<CrossCircledIcon
								...
								{options.map((option) => {
									...
									return (
										...
										>
											...
											{option.icon && <img src={option.icon} className="mr-2 h-4 w-4" />}
